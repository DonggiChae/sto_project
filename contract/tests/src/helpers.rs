...
pub async fn mint_nft(
    ...
    user.call( nft_contract.id(), "nft_mint")
...
pub async fn approve_nft(
    ...
    user.call( nft_contract.id(), "nft_approve")
        .args_json(request_payload)
        .deposit(DEFAULT_DEPOSIT)
        .transact()
        .await?;
...
pub async fn pay_for_storage(
    ...
    user.call( market_contract.id(), "storage_deposit")
        .args_json(request_payload)
        .deposit(amount)
        .transact()
        .await?;
...
pub async fn purchase_listed_nft(
    ...
    bidder.call( market_contract.id(), "offer")
        .args_json(request_payload)
...
pub async fn transfer_nft(
    ...
    sender.call( nft_contract.id(), "nft_transfer")
        .args_json(request_payload)
        .gas(DEFAULT_GAS as u64)
        .deposit(1)
        .transact()
