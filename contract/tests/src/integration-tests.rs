...
use workspaces::{network::Sandbox, sandbox, Account, Contract};
...
async fn test_nft_mint_call(
    ...
    user.call( contract.id(), "nft_mint")
...
//         "token_id": token_id,
//     });
//     first_user.call( nft_contract.id(), "nft_revoke")
